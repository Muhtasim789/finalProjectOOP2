...
> Add your screen captures to a `docs/screenshots/` folder and link them here.

| Screen | Image |
|--------|-------|
| Login with validation state | `docs/screenshots/01-login.png` |
| Sign up — pharmacy owner | `docs/screenshots/02-signup.png` |
| Super Admin dashboard | `docs/screenshots/03-superadmin-dashboard.png` |
| Manage Pharmacies | `docs/screenshots/04-manage-pharmacies.png` |
| Platform sales and commission | `docs/screenshots/05-sales-report.png` |
| Moderate reviews | `docs/screenshots/06-moderate-reviews.png` |
| Pharmacy owner dashboard | `docs/screenshots/07-admin-dashboard.png` |
| Medicine CRUD | `docs/screenshots/08-medicine-crud.png` |
| Add Medicine modal, invalid price | `docs/screenshots/09-add-medicine-validation.png` |
| Stock and inventory | `docs/screenshots/10-inventory.png` |
| Sales and earnings | `docs/screenshots/11-earnings.png` |
| Customer home with filters | `docs/screenshots/12-customer-home.png` |
| Medicine details and reviews | `docs/screenshots/13-medicine-details.png` |
| Cart spanning two pharmacies | `docs/screenshots/14-cart.png` |
| Checkout, order 1 of 2 | `docs/screenshots/15-checkout.png` |
| Printable invoice | `docs/screenshots/16-invoice.png` |
| Order history | `docs/screenshots/17-order-history.png` |
| Offers and packages | `docs/screenshots/18-offers.png` |
